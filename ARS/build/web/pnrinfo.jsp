...
<body>
    <%
    String s1=(String)session.getAttribute("id11");
    String s2=(String)session.getAttribute("id12");
    String s3=(String)session.getAttribute("id13");
    String s4=(String)session.getAttribute("id14");
    String s5=(String)session.getAttribute("id15");
    String s6=(String)session.getAttribute("id16");
    String s7=(String)session.getAttribute("id17");
    String s8=(String)session.getAttribute("id18");
    %>
